...
using MyBlogApplication.Helpers;
...
namespace BlogWebsite.Controllers
{
    ...
    public class BlogPostsController : Controller
    {
        ...
        public ActionResult Details(string Slug)
        {
            ...
            BlogPost blogPost = db.Posts.Include(p => p.Comments.Select(t => t.Author)).Where(p => p.Slug == Slug).FirstOrDefault(); ;
            if (blogPost == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult CreateComment(string slug, string body)
        {
            ...
            var blogPost = db.Posts.Where(p => p.Slug == slug).FirstOrDefault();
            if(blogPost == null)
            {
                return HttpNotFound();
            }
